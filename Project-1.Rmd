...
Adding academic acheivement (grades) to analyses as covariate
```{r}
# making a mean centered age variable 
...
stargazer(null_model_SC_CAMM_covariates, lin_model_SC_CAMM_covariates, null_SC_Transition_covariates, lin_SC_Transition_covariates, column.labels = c("Mindfulness", "School Transitions"), column.separate = c(2, 2),type = "html", out="~/path")
